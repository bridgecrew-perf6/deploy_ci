                ...
                script {
                    sshagent (credentials: ['italo']) {
                        ...
                        sh """
                            ...
                            ssh -o StrictHostKeyChecking=no 192.168.0.77 docker login -u admin -p ${passwd} https://harbor.m2digital.com.br/m2_automation
                            ssh -o StrictHostKeyChecking=no 192.168.0.77 docker run -d --name deploy_ci harbor.m2digital.com.br/m2_automation/deploy_ci:latest
                            ssh -o StrictHostKeyChecking=no 192.168.0.77 cat /etc/os-release
                        """
                    }
